...
2015-05-25 Ajout de la ligne de code qui désactive l'option "Arrêter" à l'ouverture de l'application
*******************************************************/  
...
public class MenuFenetre extends JMenuBar{
	...
	protected void addMenuDessiner() {
		...
		arreterMenuItem.setEnabled(comm.isActif()); // Désactive l'option "Arrêter" du menu si la connexion est inactive à l'ouverture de la fenêtre.
		add(menu);
	}
